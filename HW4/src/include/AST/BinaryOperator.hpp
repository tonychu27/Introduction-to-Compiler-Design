...
class BinaryOperatorNode final : public ExpressionNode {
  private:
    Operator m_op;
    unique_ptr<ExpressionNode> m_left_operand;
    unique_ptr<ExpressionNode> m_right_operand;
  ...
  public:
    ...
    const char *getOpCString() const { return kOpString[static_cast<size_t>(m_op)]; }
