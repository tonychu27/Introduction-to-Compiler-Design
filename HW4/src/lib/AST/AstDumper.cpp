...
void AstDumper::visit(ProgramNode &p_program) {
    ...
    printf("program <line: %u, col: %u> %s %s\n", p_program.getLocation().line, p_program.getLocation().col, p_program.getNameCString(), "void");
...
void AstDumper::visit(VariableNode &p_variable) {
    ...
    printf("variable <line: %u, col: %u> %s %s\n", p_variable.getLocation().line, p_variable.getLocation().col, p_variable.getNameCString(), p_variable.getTypeCString());
...
void AstDumper::visit(ConstantValueNode &p_constant_value) {
    ...
    printf("constant <line: %u, col: %u> %s\n", p_constant_value.getLocation().line, p_constant_value.getLocation().col, p_constant_value.getConstantValueCString());
}

void AstDumper::visit(FunctionNode &p_function) {
    outputIndentationSpace(m_indentation);

    printf("function declaration <line: %u, col: %u> %s %s\n", p_function.getLocation().line, p_function.getLocation().col, p_function.getNameCString(), p_function.getPrototypeCString());
...
void AstDumper::visit(CompoundStatementNode &p_compound_statement) {
    ...
    printf("compound statement <line: %u, col: %u>\n", p_compound_statement.getLocation().line, p_compound_statement.getLocation().col);
...
void AstDumper::visit(BinaryOperatorNode &p_bin_op) {
    ...
    printf("binary operator <line: %u, col: %u> %s\n", p_bin_op.getLocation().line, p_bin_op.getLocation().col, p_bin_op.getOpCString());
...
void AstDumper::visit(UnaryOperatorNode &p_un_op) {
    ...
    printf("unary operator <line: %u, col: %u> %s\n", p_un_op.getLocation().line, p_un_op.getLocation().col, p_un_op.getOpCString());
...
void AstDumper::visit(VariableReferenceNode &p_variable_ref) {
    ...
    printf("variable reference <line: %u, col: %u> %s\n", p_variable_ref.getLocation().line, p_variable_ref.getLocation().col, p_variable_ref.getNameCString());
